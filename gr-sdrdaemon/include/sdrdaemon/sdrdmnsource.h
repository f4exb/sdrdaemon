...
#ifndef INCLUDED_SDRDAEMON_SOURCE_H
#define INCLUDED_SDRDAEMON_SOURCE_H
...
*/
class SDRDAEMON_API sdrdmn_source : virtual public gr::sync_block
{
public:
	typedef boost::shared_ptr<sdrdmn_source> sptr;
	/*!
...
#endif /* INCLUDED_SDRDAEMON_SOURCE_H */
