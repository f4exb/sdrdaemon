...
#ifndef INCLUDE_UDPSINKFEC2_H_
#define INCLUDE_UDPSINKFEC2_H_
...
class UDPSinkFEC2 : public UDPSink
{
public:
    UDPSinkFEC2(const std::string& address, unsigned int port);
    virtual ~UDPSinkFEC2();
...
#pragma pack(pop)
    ...
    static void transmitUDP(UDPSinkFEC2 *udpSinkFEC, SuperBlock *txBlockx, uint16_t frameIndex, int nbBlocksFEC, int txDelay);
};
