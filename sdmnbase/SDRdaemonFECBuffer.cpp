...
bool SDRdaemonFECBuffer::writeAndRead(uint8_t *array, uint8_t *data, std::size_t& dataLength)
{
...
//            // end debug print
            ...
            if (m_cm256.cm256_decode(m_paramsCM256, m_decoderSlot.m_cm256DescriptorBlocks)) // failure to decode
            {
