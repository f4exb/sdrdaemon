...
void UDPSourceFEC::setNbBlocksFEC(int nbBlocksFEC)
{
    std::cerr << "UDPSourceFEC::setNbBlocksFEC: nbBlocksFEC: " << nbBlocksFEC << std::endl;
    m_nbBlocksFEC = nbBlocksFEC;
}

void UDPSourceFEC::read(const IQSampleVector& samples_out)
{
...
void UDPSourceFEC::receiveUDP(UDPSinkFEC *udpSinkFEC, SuperBlock *rxBlockx, uint16_t frameIndex, int nbBlocksFEC, bool cm256Valid)
{
